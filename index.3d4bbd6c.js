 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ri=[];var Ai,Pi;(Pi=Ai||(Ai={}))[Pi.DEBUG=0]="DEBUG",Pi[Pi.VERBOSE=1]="VERBOSE",Pi[Pi.INFO=2]="INFO",Pi[Pi.WARN=3]="WARN",Pi[Pi.ERROR=4]="ERROR",Pi[Pi.SILENT=5]="SILENT";const Oi={debug:Ai.DEBUG,verbose:Ai.VERBOSE,info:Ai.INFO,warn:Ai.WARN,error:Ai.ERROR,silent:Ai.SILENT},Li=Ai.INFO,Di={[Ai.DEBUG]:"log",[Ai.VERBOSE]:"log",[Ai.INFO]:"info",[Ai.WARN]:"warn",[Ai.ERROR]:"error"},Fi=(e,t,...n)=>{if(t<e.logLevel)return;const r=(new Date).toISOString(),i=Di[t];if(!i)throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`);console[i](`[${r}]  ${e.name}:`,...n)};class Mi{constructor(e){this.name=e,this._logLevel=Li,this._logHandler=Fi,this._userLogHandler=null,Ri.push(this)}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in Ai))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel="string"==typeof e?Oi[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if("function"!=typeof e)throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,Ai.DEBUG,...e),this._logHandler(this,Ai.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,Ai.VERBOSE,...e),this._logHandler(this,Ai.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,Ai.INFO,...e),this._logHandler(this,Ai.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,Ai.WARN,...e),this._logHandler(this,Ai.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,Ai.ERROR,...e),this._logHandler(this,Ai.ERROR,...e)}}const ji=(e,t)=>t.some((t=>e instanceof t));let Ui,qi;const Bi=new WeakMap,Hi=new WeakMap,$i=new WeakMap,Vi=new WeakMap,Wi=new WeakMap;let zi={get(e,t,n){if(e instanceof IDBTransaction){if("done"===t)return Hi.get(e);if("objectStoreNames"===t)return e.objectStoreNames||$i.get(e);if("store"===t)return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return Yi(e[t])},set:(e,t,n)=>(e[t]=n,!0),has:(e,t)=>e instanceof IDBTransaction&&("done"===t||"store"===t)||t in e};function Gi(e){return e!==IDBDatabase.prototype.transaction||"objectStoreNames"in IDBTransaction.prototype?(qi||(qi=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])).includes(e)?function(...t){return e.apply(Ji(this),t),Yi(Bi.get(this))}:function(...t){return Yi(e.apply(Ji(this),t))}:function(t,...n){const r=e.call(Ji(this),t,...n);return $i.set(r,t.sort?t.sort():[t]),Yi(r)}}function Ki(e){return"function"==typeof e?Gi(e):(e instanceof IDBTransaction&&function(e){if(Hi.has(e))return;const t=new Promise(((t,n)=>{const r=()=>{e.removeEventListener("complete",i),e.removeEventListener("error",s),e.removeEventListener("abort",s)},i=()=>{t(),r()},s=()=>{n(e.error||new DOMException("AbortError","AbortError")),r()};e.addEventListener("complete",i),e.addEventListener("error",s),e.addEventListener("abort",s)}));Hi.set(e,t)}(e),ji(e,Ui||(Ui=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction]))?new Proxy(e,zi):e)}function Yi(e){if(e instanceof IDBRequest)return function(e){const t=new Promise(((t,n)=>{const r=()=>{e.removeEventListener("success",i),e.removeEventListener("error",s)},i=()=>{t(Yi(e.result)),r()},s=()=>{n(e.error),r()};e.addEventListener("success",i),e.addEventListener("error",s)}));return t.then((t=>{t instanceof IDBCursor&&Bi.set(t,e)})).catch((()=>{})),Wi.set(t,e),t}(e);if(Vi.has(e))return Vi.get(e);const t=Ki(e);return t!==e&&(Vi.set(e,t),Wi.set(t,e)),t}const Ji=e=>Wi.get(e);function Xi(e,t,{blocked:n,upgrade:r,blocking:i,terminated:s}={}){const o=indexedDB.open(e,t),a=Yi(o);return r&&o.addEventListener("upgradeneeded",(e=>{r(Yi(o.result),e.oldVersion,e.newVersion,Yi(o.transaction),e)})),n&&o.addEventListener("blocked",(e=>n(e.oldVersion,e.newVersion,e))),a.then((e=>{s&&e.addEventListener("close",(()=>s())),i&&e.addEventListener("versionchange",(e=>i(e.oldVersion,e.newVersion,e)))})).catch((()=>{})),a}const Qi=["get","getKey","getAll","getAllKeys","count"],Zi=["put","add","delete","clear"],es=new Map;function ts(e,t){if(!(e instanceof IDBDatabase)||t in e||"string"!=typeof t)return;if(es.get(t))return es.get(t);const n=t.replace(/FromIndex$/,""),r=t!==n,i=Zi.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!i&&!Qi.includes(n))return;const s=async function(e,...t){const s=this.transaction(e,i?"readwrite":"readonly");let o=s.store;return r&&(o=o.index(t.shift())),(await Promise.all([o[n](...t),i&&s.done]))[0]};return es.set(t,s),s}zi=(e=>({...e,get:(t,n,r)=>ts(t,n)||e.get(t,n,r),has:(t,n)=>!!ts(t,n)||e.has(t,n)}))(zi);
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fo extends Do{constructor(){super(["online"]),this.online_=!0,"undefined"==typeof window||void 0===window.addEventListener||Yr()||(window.addEventListener("online",(()=>{this.online_||(this.online_=!0,this.trigger("online",!0))}),!1),window.addEventListener("offline",(()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))}),!1))}static getInstance(){return new Fo}getInitialEvent(e){return Rr("online"===e,"Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,((e,r)=>{Ya(r,new Uo(t.toString()+"/"+e),n)}))}class Ja{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&so(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xa{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Ja(e);const n=1e4+2e4*Math.random();uo(this.reportStats_.bind(this),Math.floor(n))}reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;so(e,((e,r)=>{r>0&&ci(this.statsToReport_,e)&&(t[e]=r,n=!0)})),n&&this.server_.reportStats(t),uo(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $l(e,t,n,r,i){const s=new ql;let o,a;if(n.type===Qa.OVERWRITE){const l=n;l.source.fromUser?o=zl(e,t,l.path,l.snap,r,i,s):(Rr(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered()&&!Ko(l.path),o=Wl(e,t,l.path,l.snap,r,i,a,s))}else if(n.type===Qa.MERGE){const l=n;l.source.fromUser?o=function(e,t,n,r,i,s,o){let a=t;return r.foreach(((r,l)=>{const c=Go(n,r);Gl(t,Bo(c))&&(a=zl(e,a,c,l,i,s,o))})),r.foreach(((r,l)=>{const c=Go(n,r);Gl(t,Bo(c))||(a=zl(e,a,c,l,i,s,o))})),a}(e,t,l.path,l.children,r,i,s):(Rr(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered(),o=Yl(e,t,l.path,l.children,r,i,a,s))}else if(n.type===Qa.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,r,i,s){let o;if(null!=Dl(r,n))return t;{const a=new Hl(r,t,i),l=t.eventCache.getNode();let c;if(Ko(n)||".priority"===Bo(n)){let n;if(t.serverCache.isFullyInitialized())n=Pl(r,dl(t));else{const e=t.serverCache.getNode();Rr(e instanceof Na,"serverChildren would be complete if leaf node"),n=Ol(r,e)}c=e.filter.updateFullNode(l,n,s)}else{const i=Bo(n);let u=Ml(r,i,t.serverCache);null==u&&t.serverCache.isCompleteForChild(i)&&(u=l.getImmediateChild(i)),c=null!=u?e.filter.updateChild(l,i,u,$o(n),a,s):t.eventCache.getNode().hasChild(i)?e.filter.updateChild(l,i,Na.EMPTY_NODE,$o(n),a,s):l,c.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=Pl(r,dl(t)),o.isLeafNode()&&(c=e.filter.updateFullNode(c,o,s)))}return o=t.serverCache.isFullyInitialized()||null!=Dl(r,qo()),cl(t,c,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const Qu="FIREBASE_DATABASE_EMULATOR_HOST",Zu={};let eh=!1;function th(e,t,n,r,i){let s=r||e.options.databaseURL;void 0===s&&(e.options.projectId||Ys("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),zs("Using default host for project ",e.options.projectId),s=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,l=ju(s,i),c=l.repoInfo;void 0!==pr&&pr.env&&(a=pr.env[Qu]),a?(o=!0,s=`http://${a}?ns=${c.namespace}`,l=ju(s,i),c=l.repoInfo):o=!l.repoInfo.secure;const u=i&&o?new po(po.OWNER):new fo(e.name,e.options,t);cu("Invalid Firebase Database URL",l),Ko(l.path)||Ys("Database URL must point to the root of a Firebase Database (not including a child path).");const h=function(e,t,n,r){let i=Zu[t.name];i||(i={},Zu[t.name]=i);let s=i[e.toURLString()];s&&Ys("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return s=new yu(e,eh,n,r),i[e.toURLString()]=s,s}(c,e,u,new ho(e.name,n));return new nh(h,e)}class nh{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(vu(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Wu(this._repo,qo())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=Zu[t];n&&n[e.key]===e||Ys(`Database ${t}(${e.repoInfo_}) has already been deleted.`),Iu(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&Ys("Cannot call "+e+" on a deleted database.")}}ra.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},ra.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _h(){return!("undefined"!=typeof navigator&&navigator&&"onLine"in navigator&&"boolean"==typeof navigator.onLine&&(yh()||Jr()||"connection"in navigator))||navigator.onLine}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class bh{constructor(e,t){this.shortDelay=e,this.longDelay=t,gh(t>e,"Short delay should be less than long delay!"),this.isMobile=Yr()||Xr()}get(){return _h()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kh(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Qh(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Yh(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(ed(t))return"Blackberry";if(td(t))return"Webos";if(Jh(t))return"Safari";if((t.includes("chrome/")||Xh(t))&&!t.includes("edge/"))return"Chrome";if(Zh(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function Yh(e=Kr()){return/firefox\//i.test(e)}function Jh(e=Kr()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Xh(e=Kr()){return/crios\//i.test(e)}function Qh(e=Kr()){return/iemobile/i.test(e)}function Zh(e=Kr()){return/android/i.test(e)}function ed(e=Kr()){return/blackberry/i.test(e)}function td(e=Kr()){return/webos/i.test(e)}function nd(e=Kr()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function rd(){return Qr()&&10===document.documentMode}function id(e=Kr()){return nd(e)||Zh(e)||td(e)||ed(e)||/windows phone/i.test(e)||Qh(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yd(e,t,n,r){return ki(e).onAuthStateChanged(t,n,r)}new WeakMap;const Jd="__sak";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xd{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(Jd,"1"),this.storage.removeItem(Jd),Promise.resolve(!0)):Promise.resolve(!1)}catch(e){return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gf=new bh(5e3,15e3),Kf="__/auth/iframe",Yf="emulator/auth/iframe",Jf={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Xf=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Qf(e){const t=e.config;fh(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?wh(t,Yf):`https://${e.config.authDomain}/${Kf}`,r={apiKey:t.apiKey,appName:e.name,v:gs},i=Xf.get(e.config.apiHost);i&&(r.eid=i);const s=e._getFrameworks();return s.length&&(r.fw=s.join(",")),`${n}?${gi(r).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
