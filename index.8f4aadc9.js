 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const es="9.22.0";function ts(e,t={}){let n=e;if("object"!=typeof t){t={name:t}}const r=Object.assign({name:$i,automaticDataCollectionEnabled:!1},t),i=r.name;if("string"!=typeof i||!i)throw Qi.create("bad-app-name",{appName:String(i)});if(n||(n=Nr()),!n)throw Qi.create("no-options");const s=Gi.get(i);if(s){if(Qr(n,s.options)&&Qr(r,s.config))return s;throw Qi.create("duplicate-app",{appName:i})}const o=new pi(i);for(const e of Ki.values())o.addComponent(e);const a=new Zi(n,r,o);return Gi.set(i,a),a}function ns(e=$i){const t=Gi.get(e);if(!t&&e===$i&&Nr())return ts();if(!t)throw Qi.create("no-app",{appName:e});return t}function rs(e,t,n){var r;let i=null!==(r=zi[e])&&void 0!==r?r:e;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=t.match(/\s|\//);if(s||o){const e=[`Unable to register library "${i}" with version "${t}":`];return s&&e.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&e.push("and"),o&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void Wi.warn(e.join(" "))}Ji(new hi(`${i}-version`,(()=>({library:i,version:t})),"VERSION"))}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
const is="firebase-heartbeat-database",ss=1,os="firebase-heartbeat-store";let as=null;function ls(){return as||(as=Fi(is,ss,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(os)}}).catch((e=>{throw Qi.create("idb-open",{originalErrorMessage:e.message})}))),as}async function cs(e,t){try{const n=(await ls()).transaction(os,"readwrite"),r=n.objectStore(os);await r.put(t,us(e)),await n.done}catch(e){if(e instanceof qr)Wi.warn(e.message);else{const t=Qi.create("idb-set",{originalErrorMessage:null==e?void 0:e.message});Wi.warn(t.message)}}}function us(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function Xo(e,t){return Us(e.name,t.name)}function Qo(e,t){return Us(e,t)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))),o.forEach((n=>{const r=function(e,t,n){return"value"===t.type||"child_removed"===t.type||(t.prevName=n.getPredecessorChildName(t.childName,t.snapshotNode,e.index_)),t}(e,n,s);i.forEach((i=>{i.respondsTo(n.type)&&t.push(i.createEvent(r,e.query_))}))}))}function Ga(e,t){return{eventCache:e,serverCache:t}}function Ka(e,t,n,r){return Ga(new Wa(t,n,r),e.serverCache)}function Ya(e,t,n,r){return Ga(e.eventCache,new Wa(t,n,r))}function Ja(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function Xa(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Il=new class{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}};class Sl{constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new Wa(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Cl(this.writes_,e,t)}}getChildAfterChild(e,t,n){const r=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:Xa(this.viewCache_),i=wl(this.writes_,r,t,1,n,e);return 0===i.length?null:i[0]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ec=1;class tc{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Za(null),this.pendingWriteTree_={visibleWrites:el.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function nc(e,t,n,r,i){return function(e,t,n,r,i){gr(r>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===i&&(i=!0),e.allWrites.push({path:t,snap:n,writeId:r,visible:i}),i&&(e.visibleWrites=tl(e.visibleWrites,t,n)),e.lastWriteId=r}(e.pendingWriteTree_,t,n,r,i),i?uc(e,new Ha({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function rc(e,t,n=!1){const r=function(e,t){for(let n=0;n<e.allWrites.length;n++){const r=e.allWrites[n];if(r.writeId===t)return r}return null}(e.pendingWriteTree_,t);if(dl(e.pendingWriteTree_,t)){let t=new Za(null);return null!=r.snap?t=t.set(ko(),!0):Ws(r.children,(e=>{t=t.set(new To(e),!0)})),uc(e,new qa(r.path,t,n))}return[]}function ic(e,t,n){return uc(e,new Ha({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function sc(e,t,n,r,i=!1){const s=t._path,o=e.syncPointTree_.get(s);let a=[];if(o&&("default"===t._queryIdentifier||Xl(o,t))){const l=Gl(o,t,n,r);0===o.views.size&&(e.syncPointTree_=e.syncPointTree_.remove(s));const c=l.removed;if(a=l.events,!i){const n=-1!==c.findIndex((e=>e._queryParams.loadsAllData())),i=e.syncPointTree_.findOnPath(s,((e,t)=>Ql(t)));if(n&&!i){const t=e.syncPointTree_.subtree(s);if(!t.isEmpty()){const n=function(e){return e.fold(((e,t,n)=>{if(t&&Ql(t)){return[Zl(t)]}{let e=[];return t&&(e=Kl(t)),Ws(n,((t,n)=>{e=e.concat(n)})),e}}))}(t);for(let t=0;t<n.length;++t){const r=n[t],i=r.query,s=fc(e,r);e.listenProvider_.startListening(_c(i),pc(e,i),s.hashFn,s.onComplete)}}}if(!i&&c.length>0&&!r)if(n){const n=null;e.listenProvider_.stopListening(_c(t),n)}else c.forEach((t=>{const n=e.queryToTagMap.get(gc(t));e.listenProvider_.stopListening(_c(t),n)}))}!function(e,t){for(let n=0;n<t.length;++n){const r=t[n];if(!r._queryParams.loadsAllData()){const t=gc(r),n=e.queryToTagMap.get(t);e.queryToTagMap.delete(t),e.tagToQueryMap.delete(n)}}}(e,c)}return a}function oc(e,t,n,r){const i=mc(e,r);if(null!=i){const r=yc(i),s=r.path,o=r.queryId,a=Lo(s,t);return vc(e,s,new Ha(Ua(o),a,n))}return[]}function ac(e,t,n,r=!1){const i=t._path;let s=null,o=!1;e.syncPointTree_.foreachOnPath(i,((e,t)=>{const n=Lo(e,i);s=s||Yl(t,n),o=o||Ql(t)}));let a,l=e.syncPointTree_.get(i);if(l?(o=o||Ql(l),s=s||Yl(l,ko())):(l=new Vl,e.syncPointTree_=e.syncPointTree_.set(i,l)),null!=s)a=!0;else{a=!1,s=pa.EMPTY_NODE;e.syncPointTree_.subtree(i).foreachChild(((e,t)=>{const n=Yl(t,ko());n&&(s=s.updateImmediateChild(e,n))}))}const c=Xl(l,t);if(!c&&!t._queryParams.loadsAllData()){const n=gc(t);gr(!e.queryToTagMap.has(n),"View does not exist, but we have a tag");const r=ec++;e.queryToTagMap.set(n,r),e.tagToQueryMap.set(r,n)}let u=zl(l,t,n,hl(e.pendingWriteTree_,i),s,a);if(!c&&!o&&!r){const n=Jl(l,t);u=u.concat(function(e,t,n){const r=t._path,i=pc(e,t),s=fc(e,n),o=e.listenProvider_.startListening(_c(t),i,s.hashFn,s.onComplete),a=e.syncPointTree_.subtree(r);if(i)gr(!Ql(a.value),"If we're adding a query, it shouldn't be shadowed");else{const t=a.fold(((e,t,n)=>{if(!Oo(e)&&t&&Ql(t))return[Zl(t).query];{let e=[];return t&&(e=e.concat(Kl(t).map((e=>e.query)))),Ws(n,((t,n)=>{e=e.concat(n)})),e}}));for(let n=0;n<t.length;++n){const r=t[n];e.listenProvider_.stopListening(_c(r),pc(e,r))}}return o}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Yc{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Jc(e,t){let n=null;for(let r=0;r<t.length;r++){const i=t[r],s=i.getPath();null===n||Do(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(i)}n&&e.eventLists_.push(n)}function Xc(e,t,n){Jc(e,n),Qc(e,(e=>Fo(e,t)||Fo(t,e)))}function Qc(e,t){e.recursionDepth_++;let n=!0;for(let r=0;r<e.eventLists_.length;r++){const i=e.eventLists_[r];if(i){t(i.path)?(Zc(e.eventLists_[r]),e.eventLists_[r]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Zc(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const r=n.getEventRunner();xs&&Ps("event: "+n.toString()),Ks(r)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ku(e,...t){throw Xu(e,...t)}function Yu(e,...t){return Xu(e,...t)}function Ju(e,t,n){const r=Object.assign(Object.assign({},Wu()),{[t]:n});return new Br("auth","Firebase",r).create(t,{appName:e.name})}function Xu(e,...t){if("string"!=typeof e){const n=t[0],r=[...t.slice(1)];return r[0]&&(r[0].appName=e.name),e._errorFactory.create(n,...r)}return $u.create(e,...t)}function Qu(e,t,...n){if(!e)throw Xu(t,...n)}function Zu(e){const t="INTERNAL ASSERTION FAILED: "+e;throw Gu(t),new Error(t)}function eh(e,t){e||Zu(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Th{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){Qu(e.idToken,"internal-error"),Qu(void 0!==e.idToken,"internal-error"),Qu(void 0!==e.refreshToken,"internal-error");const t="expiresIn"in e&&void 0!==e.expiresIn?Number(e.expiresIn):function(e){const t=_h(e);return Qu(t,"internal-error"),Qu(void 0!==t.exp,"internal-error"),Qu(void 0!==t.iat,"internal-error"),Number(t.exp)-Number(t.iat)}(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}async getToken(e,t=!1){return Qu(!this.accessToken||this.refreshToken,e,"user-token-expired"),t||!this.accessToken||this.isExpired?this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null:this.accessToken}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:n,refreshToken:r,expiresIn:i}=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class pd{constructor(){this.providerId=pd.PROVIDER_ID}static credential(e,t){return ld._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const n=fd.parseLink(t);return Qu(n,"argument-error"),ld._fromEmailAndCode(e,n.code,n.tenantId)}}pd.PROVIDER_ID="password",pd.EMAIL_PASSWORD_SIGN_IN_METHOD="password",pd.EMAIL_LINK_SIGN_IN_METHOD="emailLink";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const nf="recaptcha";async function rf(e,t,n){var r;const i=await n.verify();try{let s;if(Qu("string"==typeof i,e,"argument-error"),Qu(n.type===nf,e,"argument-error"),s="string"==typeof t?{phoneNumber:t}:t,"session"in s){const t=s.session;if("phoneNumber"in s){Qu("enroll"===t.type,e,"internal-error");const n=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e,t){return hh(e,"POST","/v2/accounts/mfaEnrollment:start",uh(e,t))}(e,{idToken:t.credential,phoneEnrollmentInfo:{phoneNumber:s.phoneNumber,recaptchaToken:i}});return n.phoneSessionInfo.sessionInfo}{Qu("signin"===t.type,e,"internal-error");const n=(null===(r=s.multiFactorHint)||void 0===r?void 0:r.uid)||s.multiFactorUid;Qu(n,e,"missing-multi-factor-info");const o=await function(e,t){return hh(e,"POST","/v2/accounts/mfaSignIn:start",uh(e,t))}(e,{mfaPendingCredential:t.credential,mfaEnrollmentId:n,phoneSignInInfo:{recaptchaToken:i}});return o.phoneResponseInfo.sessionInfo}}{const{sessionInfo:t}=await async function(e,t){return hh(e,"POST","/v1/accounts:sendVerificationCode",uh(e,t))}(e,{phoneNumber:s.phoneNumber,recaptchaToken:i});return t}}finally{n._reset()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function of(e,t){return t?xh(t):(Qu(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Af=new sh(5e3,15e3),Of="__/auth/iframe",Lf="emulator/auth/iframe",Df={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Ff=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Mf(e){const t=e.config;Qu(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?oh(t,Lf):`https://${e.config.authDomain}/${Of}`,r={apiKey:t.apiKey,appName:e.name,v:es},i=Ff.get(e.config.apiHost);i&&(r.eid=i);const s=e._getFrameworks();return s.length&&(r.fw=s.join(",")),`${n}?${ei(r).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t||"",a),new Uf(null);const h=window.open(t||"",a,u);Qu(h,e,"popup-blocked");try{h.focus()}catch(e){}return new Uf(h)}const Bf="__/auth/handler",Hf="emulator/auth/handler",Vf=encodeURIComponent("fac");async function Wf(e,t,n,r,i,s){Qu(e.config.authDomain,e,"auth-domain-config-required"),Qu(e.config.apiKey,e,"invalid-api-key");const o={apiKey:e.config.apiKey,appName:e.name,authType:n,redirectUrl:r,v:es,eventId:i};if(t instanceof gd){t.setDefaultLanguage(e.languageCode),o.providerId=t.providerId||"",Jr(t.getCustomParameters())||(o.customParameters=JSON.stringify(t.getCustomParameters()));for(const[e,t]of Object.entries(s||{}))o[e]=t}if(t instanceof md){const e=t.getScopes().filter((e=>""!==e));e.length>0&&(o.scopes=e.join(","))}e.tenantId&&(o.tid=e.tenantId);const a=o;for(const e of Object.keys(a))void 0===a[e]&&delete a[e];const l=await e._getAppCheckToken(),c=l?`#${Vf}=${encodeURIComponent(l)}`:"";return`${function({config:e}){return e.emulator?oh(e,Hf):`https://${e.authDomain}/${Bf}`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e)}?${ei(a).slice(1)}${c}`}const $f="webStorageSupport";const zf=class{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=qd,this._completeRedirectFn=bf,this._overrideRedirectResult=yf}async _openPopup(e,t,n,r){var i;eh(null===(i=this.eventManagers[e._key()])||void 0===i?void 0:i.manager,"_initialize() not called before _openPopup()");return qf(e,await Wf(e,t,n,th(),r),Hd())}async _openRedirect(e,t,n,r){await this._originValidation(e);return function(e){Wd().location.href=e}(await Wf(e,t,n,th(),r)),new Promise((()=>{}))}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:e,promise:n}=this.eventManagers[t];return e?Promise.resolve(e):(eh(n,"If manager is not set, promise should be"),n)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch((()=>{delete this.eventManagers[t]})),n}async initAndGetManager(e){const t=await async function(e){const t=await Pf(e),n=Wd().gapi;return Qu(n,e,"internal-error"),t.open({where:document.body,url:Mf(e),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Df,dontclear:!0},(t=>new Promise((async(n,r)=>{await t.restyle({setHideOnLeave:!1});const i=Yu(e,"network-request-failed"),s=Wd().setTimeout((()=>{r(i)}),Af.get());function o(){Wd().clearTimeout(s),n(t)}t.ping(o).then(o,(()=>{r(i)}))}))))}(e),n=new wf(e);return t.register("authEvent",(t=>{Qu(null==t?void 0:t.authEvent,e,"invalid-auth-event");return{status:n.onEvent(t.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send($f,{type:$f},(n=>{var r;const i=null===(r=null==n?void 0:n[0])||void 0===r?void 0:r[$f];void 0!==i&&t(!!i),Ku(e,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=If(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Vh()||Dh()||Bh()}};var Gf="@firebase/auth",Kf="0.23.2";
/**
 * @license
 * Copyright 2020 Google LLC
 *
