 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rt{constructor(e,t){this.source=e,this.path=t,this.type=Pt.LISTEN_COMPLETE}operationForChild(e){return xe(this.path)?new Rt(this.source,ve()):new Rt(this.source,we(this.path))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var F;F="",v(new(0,r.Component)("platform-logger",(e=>new l(e)),"PRIVATE")),v(new(0,r.Component)("heartbeat",(e=>new R(e)),"PRIVATE")),x(c,u,F),x(c,u,"esm2017"),x("fire-js","")})),s.register("6ExWU",(function(t,n){e(t.exports,"Component",(function(){return i})),e(t.exports,"ComponentContainer",(function(){return l}));var r=s("2xDiJ");class i{constructor(e,t,n){this.name=e,this.instanceFactory=t,this.type=n,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
async function xe(e,t){return A(e,"POST","/v1/accounts:signInWithPassword",P(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function He(e,t){return A(e,"POST","/v1/accounts:signUp",P(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
(0,s("MjY8E").registerVersion)("firebase","9.22.0","app")})),s.register("2yFaI",(function(t,r){e(t.exports,"initialShoppingList",(function(){return m}));var i=s("lRSMh"),o=s("1VFfL"),a=s("eZig4");s("a0DK1");var l=s("bkiPU");let c,u,d,h=i.default.shoppingList().length,p=1;document.querySelector(".state-button").addEventListener("click",(()=>{console.log(i.default.shoppingList())}));const f=matchMedia("(max-width: 767px)"),g=matchMedia("(max-width: 374px)");function m(){console.log(i.default.shoppingList()),h=i.default.shoppingList().length,f.matches?(c=4,u=2,y(),(0,a.renderCurrentBookCards)(v(1,c))):(c=3,u=3,w(),(0,a.renderCurrentBookCards)(v(1,c)))}function v(e,t){console.log(`Page number: ${p}`);const n=i.default.shoppingList().filter(((e,n)=>n>=p*t-t&&n<=p*t-1));if(n.length)return console.log(n),n;if(p-=1,h=i.default.shoppingList().length,console.log(`new current page ${p}`),0===p)return console.log("show plug"),void document.querySelector(".js-plug").classList.remove("visually-hidden");_({totalItmes:h,itemsPerPage:t,visiblePages:u,page:p});const r=i.default.shoppingList().filter(((e,n)=>n>=p*t-t&&n<=p*t-1));return console.log(r),r}function _({totalItmes:e,itemsPerPage:t,visiblePages:r,page:i}){const s=document.querySelector(".paginator-container");e>t&&s.classList.remove("visually-hidden");const o={usageStatistics:!1,totalItems:e,itemsPerPage:t,visiblePages:r,page:i,centerAlign:!1,firstItemClassName:"tui-first-child",lastItemClassName:"tui-last-child",template:{page:'<a href="#" class="pagination__pages tui-page-btn">{{page}}</a>',currentPage:'<strong class="pagination__pages tui-page-btn tui-is-selected">{{page}}</strong>',moveButton:`<a href="#" class="tui-page-btn tui-{{type}}"><svg class="tui-ico-{{type}}"><use href="${n(l)}#icon-{{type}}"></use></svg></a>`,disabledMoveButton:`<span class="tui-page-btn tui-is-disabled tui-{{type}}"><svg class="tui-ico-{{type}}"><use href="${n(l)}#icon-{{type}}"></use></svg></span>`,moreButton:'<a href="#" class="pagination__pages tui-page-btn tui-{{type}}-is-ellip"><span class="tui-ico-ellip">...</span></a>'}},a={usageStatistics:!1,totalItems:e,itemsPerPage:t,visiblePages:1,page:i,centerAlign:!1,firstItemClassName:"tui-first-child",lastItemClassName:"tui-last-child",template:{page:'<a href="#" class="pagination__pages tui-page-btn">{{page}}</a>',moveButton:`<a href="#" class="tui-page-btn tui-{{type}}"><svg class="tui-ico-{{type}}"><use href="${n(l)}#icon-{{type}}"></use></svg></a>`,disabledMoveButton:`<span class="tui-page-btn tui-is-disabled tui-{{type}}"><svg class="tui-ico-{{type}}"><use href="${n(l)}#icon-{{type}}"></use></svg></span>`}};g.matches?b(s,a):b(s,o),g.addEventListener("change",(e=>{e.matches?b(s,a):b(s,o)})),e<=t&&s.classList.add("visually-hidden")}function y(){_({totalItmes:h,itemsPerPage:c,visiblePages:u,page:p})}function w(){_({totalItmes:h,itemsPerPage:c,visiblePages:u,page:p})}function b(e,t){new(n(o))(e,t).on("afterMove",(e=>{p=e.page,console.log(`Moved to page ${p}`);const t=v(e.page,c);(0,a.renderCurrentBookCards)(t)}))}f.addEventListener("change",(e=>{e.matches?(c=4,u=2,y(),(0,a.renderCurrentBookCards)(v(1,4)),d=Math.ceil(h/c),console.log("4")):(c=3,u=3,w(),console.log("3"),(0,a.renderCurrentBookCards)(v(1,3)),d=Math.ceil(h/c))})),document.body.addEventListener("click",(e=>{e.target.classList.contains("js-shopping-list-delete-button")&&(i.default.setShoppingList(i.default.shoppingList().filter((t=>t._id!==e.target.dataset.cardId))),h=i.default.shoppingList().length,_({totalItmes:h,itemsPerPage:c,visiblePages:u,page:p}),console.log("THIS"),console.log(v(p,c)),(0,a.renderCurrentBookCards)(v(p,c)),console.log(p),console.log(i.default.shoppingList()))}))})),s.register("1VFfL",(function(e,t){
/*!
 * TOAST UI Pagination
 * @version 3.4.1
