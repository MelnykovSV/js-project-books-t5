 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lt{constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Pt.OVERWRITE}operationForChild(e){return Ee(this.path)?new Lt(this.source,ve(),this.snap.getImmediateChild(e)):new Lt(this.source,we(this.path),this.snap)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dt{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Pt.MERGE}operationForChild(e){if(Ee(this.path)){const t=this.children.subtree(new me(e));return t.isEmpty()?null:t.value?new Lt(this.source,ve(),t.value):new Dt(this.source,ve(),t)}return(0,o.assert)(_e(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Dt(this.source,we(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Br{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Wr(e,t){let n=null;for(let r=0;r<t.length;r++){const i=t[r],s=i.getPath();null===n||Ie(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(i)}n&&e.eventLists_.push(n)}function zr(e,t,n){Wr(e,n),Vr(e,(e=>ke(e,t)||ke(t,e)))}function Vr(e,t){e.recursionDepth_++;let n=!0;for(let r=0;r<e.eventLists_.length;r++){const i=e.eventLists_[r];if(i){t(i.path)?($r(e.eventLists_[r]),e.eventLists_[r]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function $r(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const r=n.getEventRunner();b&&C("event: "+n.toString()),q(r)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ti{constructor(e,t,n,r){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=r}get key(){return Ee(this._path)?null:be(this._path)}get ref(){return new xi(this._repo,this._path)}get _queryIdentifier(){const e=bt(this._queryParams),t=D(e);return"{}"===t?"default":t}get _queryObject(){return bt(this._queryParams)}isEqual(e){if(!((e=(0,o.getModularInstance)(e))instanceof Ti))return!1;const t=this._repo===e._repo,n=Ie(this._path,e._path),r=this._queryIdentifier===e._queryIdentifier;return t&&n&&r}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}}class xi extends Ti{constructor(e,t){super(e,t,new yt,!1)}get parent(){const e=xe(this._path);return null===e?null:new xi(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}}class Ci{constructor(e,t,n){this._node=e,this.ref=t,this._index=n}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new me(e),n=Si(this.ref,e);return new Ci(this._node.getChild(t),n,Qe)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){if(this._node.isLeafNode())return!1;return!!this._node.forEachChild(this._index,((t,n)=>e(new Ci(n,Si(this.ref,t),Qe))))}hasChild(e){const t=new me(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Ei(e,t){return(e=(0,o.getModularInstance)(e))._checkNotDeleted("ref"),void 0!==t?Si(e._root,t):e._root}function Si(e,t){return null===_e((e=(0,o.getModularInstance)(e))._path)?Ur("child","path",t,!1):jr("child","path",t,!1),new xi(e._repo,Ce(e._path,t))}function Ii(e,t){e=(0,o.getModularInstance)(e),Hr("set",e._path),Mr("set",t,e._path,!1);const n=new(0,o.Deferred);return ri(e._repo,e._path,t,null,n.wrapCallback((()=>{}))),n.promise}function ki(e){e=(0,o.getModularInstance)(e);const t=new bi((()=>{})),n=new Pi(t);return function(e,t,n){const r=nr(e.serverSyncTree_,t);return null!=r?Promise.resolve(r):e.server_.get(t).then((r=>{const i=ct(r).withIndex(t._queryParams.getIndex());let s;if(er(e.serverSyncTree_,t,n,!0),t._queryParams.loadsAllData())s=Jn(e.serverSyncTree_,t._path,i);else{const n=ar(e.serverSyncTree_,t);s=Zn(e.serverSyncTree_,t._path,i,n)}return zr(e.eventQueue_,t._path,s),Qn(e.serverSyncTree_,t,n,null,!0),i}),(n=>(si(e,"get for query "+(0,o.stringify)(t)+" failed: "+n),Promise.reject(new Error(n)))))}(e._repo,e,n).then((t=>new Ci(t,new xi(e._repo,e._path),e._queryParams.getIndex())))}class Pi{constructor(e){this.callbackContext=e}respondsTo(e){return"value"===e}createEvent(e,t){const n=t._queryParams.getIndex();return new yi("value",this,new Ci(e.snapshotNode,new xi(t._repo,t._path),n))}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new wi(this,e,t):null}matches(e){return e instanceof Pi&&(!e.callbackContext||!this.callbackContext||e.callbackContext.matches(this.callbackContext))}hasAnyCallback(){return null!==this.callbackContext}}!function(e){(0,o.assert)(!Ln,"__referenceConstructor has already been defined"),Ln=e}(xi),function(e){(0,o.assert)(!Dn,"__referenceConstructor has already been defined"),Dn=e}(xi);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function Xe(e,{displayName:t,photoURL:n}){if(void 0===t&&void 0===n)return;const i=(0,r.getModularInstance)(e),s={idToken:await i.getIdToken(),displayName:t,photoUrl:n,returnSecureToken:!0},o=await U(i,
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const xt="recaptcha";async function Ct(e,t,n){var r;const i=await n.verify();try{let s;if(_("string"==typeof i,e,"argument-error"),_(n.type===xt,e,"argument-error"),s="string"==typeof t?{phoneNumber:t}:t,"session"in s){const t=s.session;if("phoneNumber"in s){_("enroll"===t.type,e,"internal-error");const n=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
